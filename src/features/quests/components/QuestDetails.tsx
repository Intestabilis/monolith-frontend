...
export function QuestDetails({
  ...
  return (
    <div
      key={questId}
      className="flex flex-col h-full w-full min-w-0 overflow-y-scroll overflow-x-hidden scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent pr-2"
    >
      {isMaster && !isEditing && (
